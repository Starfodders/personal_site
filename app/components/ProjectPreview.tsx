...
const ProjectPreview = () => {
  return (
<div className='flex flex-col gap-10 p-4 mb-16 flex-wrap items-start md:items-start md:p-10 lg:flex-row lg:justify-start lg:max-w-[95%] lg:m-auto lg:gap-18 lg:mb-56 xl:max-w-[68%]' id = "projects">
  ...
  <div className='flex flex-col gap-10 py-4 px-6 items-center md:items-start md:h-full lg:w-full'>
      ...
      <div className='w-full bg-[#19232C] min-h-[200px] flex flex-col gap-3 rounded-md max-w-[400px] m-auto md:w-1/2 md:min-w-[350px] lg:w-1/3 lg:m-0'>
