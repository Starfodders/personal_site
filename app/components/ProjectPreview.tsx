...
const ProjectPreview = () => {
  ...
  return (
    <div className='flex flex-col gap-10 p-4 mb-16 flex-wrap items-start md:items-start md:p-10 lg:flex-row lg:justify-center lg:max-w-[1200px] lg:m-auto lg:gap-18 lg:mb-56 xl:max-w-[70%] 2xl:max-w-[50%]' id="projects">
      ...
      <div className='group w-full bg-[#19232C] min-h-[200px] flex flex-col gap-3 rounded-md max-w-[400px] m-auto md:w-1/2 md:min-w-[330px] lg:w-1/5 lg:m-0 hover:bg-[#202b36] hover:transition-all duration-500'>
        <Link href="./components/projects/task-manager">
          <div className='group w-full bg-white max-h-[200px] rounded-t-md overflow-hidden'>
            <img src={'/previews/taskManPreview.png'} alt='' className='w-full rounded-t-md max-h-[200px] min-h-[200px] object-cover group-hover:scale-110 transition-all duration-500' loading='lazy' />
          </div>
          <div className="w-full min-h-[50%] flex flex-col gap-1 p-5">
            <h4 className='font-poppins text-xl font-bold'>Task Manager</h4>
            <p className="font-mono text-sm">List Tracking</p>
            <div className='w-full flex gap-2 mt-2 flex-wrap'>
              <p className="font-poppins text-xs text-[#BEBEBE] bg-black py-0.5 px-2 rounded-lg">React/Redux</p>
              <p className="font-poppins text-xs text-[#BEBEBE] bg-black py-0.5 px-2 rounded-lg">Typescript</p>
              <p className="font-poppins text-xs text-[#BEBEBE] bg-black py-0.5 px-2 rounded-lg">Python</p>
              <p className="font-poppins text-xs text-[#BEBEBE] bg-black py-0.5 px-2 rounded-lg">Django</p>
              <p className="font-poppins text-xs text-[#BEBEBE] bg-black py-0.5 px-2 rounded-lg">Redis</p>
      ...
      <div className='group w-full bg-[#19232C] min-h-[200px] flex flex-col gap-3 rounded-md max-w-[400px] m-auto md:w-1/2 md:min-w-[330px] lg:w-1/5 lg:m-0 hover:bg-[#202b36] hover:transition-all duration-500'>
        <Link href="./components/projects/maps">
          ...
          <div className="w-full min-h-[50%] flex flex-col gap-1 p-5 lg:min-h-[9.6rem]">
